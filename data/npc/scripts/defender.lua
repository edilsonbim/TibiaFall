...
local config = {
    attackRadius = {x = 60, y = 60, targetDistance = 1, walkDistance = 25},
...
function onThink()
    ...
    doTargetCombatHealth(npcId, targetId, COMBAT_PHYSICALDAMAGE, -config.damageValue.min, -config.damageValue.max, CONST_ME_BLOCKHIT)
    npcPosition:sendDistanceEffect(targetPosition, CONST_ANI_BOLT)
