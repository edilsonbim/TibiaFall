...
local events = {
    ...
    'bonusPreyLootKill',
    'bossesMissionCults',
    'ReflectStatsHealthChange',
    'ReflectStatsManaChange',
    'AttributesAdvance',
    'Durab',
    'DurabTime'
...
            - Commands -]]
    ...
    if (player:hasNoMove()) then 
        playerStartNoMove(player:getId(), player:getPosition(), player:getDirection())
    end 
    registerCreatureEvent(cid, "Durab")
    registerCreatureEvent(cid, "DurabTime")
