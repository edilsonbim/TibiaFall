...
{
	CONST_SLOT_HEAD, CONST_SLOT_NECKLACE, CONST_SLOT_ARMOR, CONST_SLOT_RIGHT, CONST_SLOT_LEFT, CONST_SLOT_LEGS, CONST_SLOT_FEET, CONST_SLOT_RING
}
function Player.hasEquipment(self)
	local item 
	for i = 1, #equipmentSlots do 
		item = self:getSlotItem(equipmentSlots[i])
		if (item) then 
			return true 
		end
	end 
